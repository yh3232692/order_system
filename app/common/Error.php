<?php
    ...
    class Error {
        ...
        const UPDATE_SUCCESS = "更新数据成功";
        const UPDATE_ERROR = "更新数据失败";
        ...
        const ID_IS_EMPTY = "ID不能为空";
        const NAME_ALREADY_EXIST = "名称已经存在";
        const NAME_IS_EMPTY = "名称不能为空";
        const CODE_ALREADY_EXIST = "编号已经存在";
        const CODE_IS_EMPTY = "编号不能为空";
        const IP_ALREADY_EXIST = "ip已经存在";
        const IP_IS_EMPTY = "ip不能为空";
