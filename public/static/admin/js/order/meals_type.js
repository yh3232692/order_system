$(function () {
    (function () {
        ...
        function load_upload (is_add) {
            if (is_add === true) {
                var $image = $("#addForm .image-crop > img");
            }
            if (is_add === false) {
                var $image = $("#editForm .image-crop > img");
            }
            $image.cropper({
                aspectRatio: 4/3,
                preview: ".img-preview",
                    ...
                    if (is_add === true) {
                        $("#addForm textarea[name='base64_data']").val(data_url);
                    }
                    if (is_add === false) {
                        $("#editForm textarea[name='base64_data']").val(data_url);
                    }
                },
            });
            if (is_add === true) {
            ...
            if (window.FileReader) {
                $inputImage.change(function () {
                    ...
                    $('.yulan').removeClass('hide');
                    $('.yuantu').removeClass('hide');
